...
file_name = 'Yuenlong.txt'
# create output file for transaction record
outputFileNamePrefix = "output2/yuenlong/"
...
def generate_payload(record_size, to_offset, age_range):
    payload = {"postType": "Both", "day": "Day1095", "sort": "InsOrRegDate", "order": "Descending", "size": record_size,
               "mtrs": [], "primarySchoolNets": [],
               "typeCodes": ["19-HMA150", "19-HMA136", "19-HMA031", "19-HMA084", "19-HMA191", "19-HMA087", "19-HMA083",
                             "19-HMA190", "19-HMA030", "19-HMA029", "19-HMA009", "19-HMA008", "19-HMA007", "19-HMA006",
                             "19-HMA149"], "offset": to_offset, "pageSource": "search",
               "buildingAgeRange": {"min": age_range, "max": age_range}, "universities": [], "estateUsages": ["HOS", "PRH", "RE"]}
    return payload

# loop through each age range
for ageRange in range(68):
# for ageRange in range(68):
    # reset page offset
    offset = 0
